...
|phidget.on, phidget.addListener|"event name", eventHandler| This is how you bind to the phidget devices events.|
|phidget.removeListener|"event name", eventHandler| This is how you release any bound events to the phidget devices events.|
