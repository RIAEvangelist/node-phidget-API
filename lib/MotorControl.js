...
function PhidgetMotorControl(){
    ...
    function getAccelerationMax(){
        return phidget.data.board.AccelerationMax;
    }

    function getAccelerationMin(){
        return phidget.data.board.AccelerationMin;
    }
    ...
    phidget.on(
        ...
        function(data){
            ...
            for (var i = 0; i < phidget.data.board.MotorCount; i++){
                ...
                //Motors might accedentally be destroyed if accelerations are
                //used incorrectly
                phidget.set(
                    {
                        type: 'Acceleration',
            ...
            for (var i = 0; i < phidget.data.board.EncoderCount; i++){
            ...
            for (var i = 0; i < phidget.data.board.SensorCount ; i++){
